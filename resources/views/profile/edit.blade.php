                        ...
                        <div>
                            ...
                            <div class="flex gap-3">
                                <label class="flex items-center gap-2 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                    <input type="radio" name="dark_mode" value="0" {{ ($user->theme ?? 'light') !== 'dark' ? 'checked' : '' }} class="text-blue-600 focus:ring-blue-500">
                                ...
                                <label class="flex items-center gap-2 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                    <input type="radio" name="dark_mode" value="1" {{ ($user->theme ?? 'light') === 'dark' ? 'checked' : '' }} class="text-blue-600 focus:ring-blue-500">
